package si.uni_lj.fri.pbd.stkp.orientation;
...
import si.uni_lj.fri.pbd.stkp.MapsActivity;
import si.uni_lj.fri.pbd.stkp.orientation.representation.Quaternion;
...
public class ImprovedOrientationSensor2Provider extends OrientationProvider{
    ...
    public ImprovedOrientationSensor2Provider(SensorManager sensorManager, MapsActivity mapsActivity) {
        super(sensorManager);
